//test if html and js are paired
console.log("Theres a raccoon in the chimney");
//references
...
console.log("ul innerTextL", ulRef.innerText);

console.log("ul innterHTML", ulRef.innerHTML);

pRef.innerText = "The cozy old farmer ate a green rock";
...
h1Ref.style.backgroundColor = "crimson"; //chin
h1Ref.style.color = "white";

pRef.style.backgroundColor = "#00ff00";
pRef.style.color = "rgb(155, 50, 0)";
...
inputRef.setAttribute("placeholder", "Raccoon eating butter");
